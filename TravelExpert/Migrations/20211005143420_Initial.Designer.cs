...
namespace TravelExpert.Migrations
{
    ...
    [Migration("20211005143420_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelExpert.Models.Affiliation", b =>
                {
            ...
            modelBuilder.Entity("TravelExpert.Models.Agency", b =>
                {
            ...
            modelBuilder.Entity("TravelExpert.Models.Agent", b =>
                {
            ...
            modelBuilder.Entity("TravelExpert.Models.Booking", b =>
                {
            ...
            modelBuilder.Entity("TravelExpert.Models.BookingDetail", b =>
                {
            ...
            modelBuilder.Entity("TravelExpert.Models.Class", b =>
                {
                    b.Property<string>("ClassId")
                        .HasMaxLength(5)
                        .HasColumnType("nvarchar(5)");
            ...
            modelBuilder.Entity("TravelExpert.Models.CreditCard", b =>
                {
            ...
            modelBuilder.Entity("TravelExpert.Models.Customer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TravelExpert.Models.CustomersReward", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExpert.Models.Employee", b =>
                {
            ...
            modelBuilder.Entity("TravelExpert.Models.Fee", b =>
                {
                    b.Property<string>("FeeId")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
            ...
            modelBuilder.Entity("TravelExpert.Models.Package", b =>
                {
                    b.Property<int>("PackageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TravelExpert.Models.PackagesProductsSupplier", b =>
                {
                    b.Property<int>("PackageId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExpert.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("TravelExpert.Models.ProductsSupplier", b =>
                {
                    b.Property<int>("ProductSupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TravelExpert.Models.Region", b =>
                {
                    b.Property<string>("RegionId")
                        .HasMaxLength(5)
                        .HasColumnType("nvarchar(5)");
            ...
            modelBuilder.Entity("TravelExpert.Models.Reward", b =>
                {
                    b.Property<int>("RewardId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExpert.Models.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TravelExpert.Models.SupplierContact", b =>
                {
            ...
            modelBuilder.Entity("TravelExpert.Models.TripType", b =>
                {
                    b.Property<string>("TripTypeId")
                        .HasMaxLength(1)
                        .HasColumnType("nvarchar(1)");
            ...
            modelBuilder.Entity("TravelExpert.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TravelExpert.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TravelExpert.Models.Agent", b =>
                {
                    b.HasOne("TravelExpert.Models.Agency", "Agency")
                        .WithMany("Agents")
            ...
            modelBuilder.Entity("TravelExpert.Models.Booking", b =>
                {
                    b.HasOne("TravelExpert.Models.Customer", "Customer")
                        .WithMany("Bookings")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("Bookings_FK00");

                    b.HasOne("TravelExpert.Models.Package", "Package")
                        .WithMany("Bookings")
                        .HasForeignKey("PackageId")
                        .HasConstraintName("Bookings_FK01");

                    b.HasOne("TravelExpert.Models.TripType", "TripType")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("TravelExpert.Models.Customer", b =>
                {
                    b.HasOne("TravelExpert.Models.Agent", "Agent")
                        .WithMany("Customers")
            ...
            modelBuilder.Entity("TravelExpert.Models.CustomersReward", b =>
                {
                    ...
                    b.HasOne("TravelExpert.Models.Reward", "Reward")
                        .WithMany("CustomersRewards")
            ...
            modelBuilder.Entity("TravelExpert.Models.ProductsSupplier", b =>
                {
                    b.HasOne("TravelExpert.Models.Product", "Product")
                        .WithMany("ProductsSuppliers")
                        .HasForeignKey("ProductId")
                        .HasConstraintName("Products_Suppliers_FK00");

                    b.HasOne("TravelExpert.Models.Supplier", "Supplier")
                        .WithMany("ProductsSuppliers")
            ...
            modelBuilder.Entity("TravelExpert.Models.SupplierContact", b =>
                {
                    b.HasOne("TravelExpert.Models.Affiliation", "Affiliation")
